About delimited-protobuf-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/delimited-protobuf-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13966&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/delimited-protobuf-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `delimited-protobuf` can be installed with `conda`:
...
```
mamba install delimited-protobuf
```

It is possible to list all of the versions of `delimited-protobuf` available on your platform with `conda`:
...
```
mamba search delimited-protobuf --channel conda-forge
```
...
mamba repoquery search delimited-protobuf --channel conda-forge

# List packages depending on `delimited-protobuf`:
mamba repoquery whoneeds delimited-protobuf --channel conda-forge

# List dependencies of `delimited-protobuf`:
mamba repoquery depends delimited-protobuf --channel conda-forge
```
